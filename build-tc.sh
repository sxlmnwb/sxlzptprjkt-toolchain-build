...
# GH_PUSH_REPO_URL | Your Repository for store compiled Toolchain ( without https:// or www. ) ex. github.com/sxlmnwb/sxlzptprjkt-clang
...
git add .
git commit -asm "$LLVM_NAME: building $date
